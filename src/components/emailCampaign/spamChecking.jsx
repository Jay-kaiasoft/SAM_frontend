...
const spamCheckText2 = "WARNING! It is highly recommended you give us permission to send email on your behalf with our <a href='' class='hover'>Trusted Domain process.</a><br>If you do not know the owner of the domain or go through this setup, please use an internet email account such as Hotmail or Gmail."
        ...
        <Row>
            <Col xs={10} sm={10} md={10} lg={10} xl={10} className="mx-auto">
                ...
                <div className="spam-container">
                    <div className="spam-container-inner mr-5">
                        <p className="inner-heading">For A</p>
                        {
                    ...
                    <div className="spam-container-inner margin-top">
                        <p className="inner-heading">For B</p>
                        {
                            !["gmail.com", "yahoo.com", "yahoo.co.in", "hotmail.com", "outlook.com", "msn.com", "live.com", "zoho.com", "mail.com", "aol.com"].includes(data.fromAddress.split("@")[1]) ?
                                <>
                                    <p className="font-size-18"><strong>Authentication Check</strong></p>
                        ...
                        <div className="row my-3">
                            <div className="col-6 d-flex align-items-center">
                                {
                                    typeof spamCheckDetails?.checkSubjectContentB?.localSpamScore === "undefined" ?
                                        <div className="spam-check-indicator"><div className="lds-ripple"><div></div><div></div></div></div>
                                        :
                                        <div className={`spam-check-indicator ${parseFloat(spamCheckDetails.checkSubjectContentB.localSpamScore) < 5 ? "green" : "red"}`}></div>
                                }
                                <p className="w-75 mb-0">Spamassassin</p>
                                {
                                    typeof spamCheckDetails?.checkSubjectContentB?.localSpamScore !== "undefined" ?
                            ...
                            {/*<div className="col d-flex align-items-center">*/}
                            {/*    {*/}
                            {/*        typeof spamCheckDetails?.checkSubjectContentB?.gmailSpam === "undefined" ?*/}
                            {/*            <div className="spam-check-indicator"><div className="lds-ripple"><div></div><div></div></div></div>*/}
                            {/*            :*/}
                            {/*            <div className={`spam-check-indicator ${spamCheckDetails.checkSubjectContentB.gmailSpam === 0 ? "green" : "red"}`}></div>*/}
                            {/*    }*/}
                            {/*    <p className="w-75 mb-0">Gmail</p>*/}
                            {/*    {*/}
                            {/*        typeof spamCheckDetails?.checkSubjectContentB?.gmailSpam !== "undefined" ?*/}
                        ...
                        {/*    <div className="col d-flex align-items-center">*/}
                        {/*        {*/}
                        {/*            typeof spamCheckDetails?.checkSubjectContentB?.outlookSpam === "undefined" ?*/}
                        {/*                <div className="spam-check-indicator"><div className="lds-ripple"><div></div><div></div></div></div>*/}
                        {/*                :*/}
                        {/*                <div className={`spam-check-indicator ${spamCheckDetails.checkSubjectContentB.outlookSpam === 0 ? "green" : "red"}`}></div>*/}
                        {/*        }*/}
                        {/*        <p className="w-75 mb-0">Hotmail</p>*/}
                        {/*        {*/}
                        {/*            typeof spamCheckDetails?.checkSubjectContentB?.outlookSpam !== "undefined" ?*/}
                        ...
                        {/*    <div className="col d-flex align-items-center">*/}
                        {/*        {*/}
                        {/*            typeof spamCheckDetails?.checkSubjectContentB?.outlookClientSpam === "undefined" ?*/}
                        {/*                <div className="spam-check-indicator"><div className="lds-ripple"><div></div><div></div></div></div>*/}
                        {/*                :*/}
                        {/*                <div className={`spam-check-indicator ${spamCheckDetails.checkSubjectContentB.outlookClientSpam === 0 ? "green" : "red"}`}></div>*/}
                        {/*        }*/}
                        {/*        <p className="w-75 mb-0">Outlook Client</p>*/}
                        {/*        {*/}
                        {/*            typeof spamCheckDetails?.checkSubjectContentB?.outlookClientSpam !== "undefined" ?*/}
                        ...
                        <div className="row">
                            <div className="col-12 d-flex align-items-center">
                                {
                                    typeof spamCheckDetails?.checkSubjectContentB?.emailSubjectColor === "undefined" ?
                                        <div className="spam-check-indicator"><div className="lds-ripple"><div></div><div></div></div></div>
                                        :
                                        <div className={`spam-check-indicator ${spamCheckDetails.checkSubjectContentB.emailSubjectColor === 1 ? "green" : "red"}`}></div>
                                }
                                <p className="mb-0">Email Subject Check</p>
                                {
                                    typeof spamCheckDetails?.checkSubjectContentB?.emailSubjectColor !== "undefined" ?
                                        <i className="far fa-question-circle ml-3 font-size-18" data-toggle="tooltip" title={`${spamCheckDetails.checkSubjectContentB.emailSubjectColor === 1 ? "Good to go" : "May be SPAM"}`}></i>
                                        : null
                                }
                            </div>
                            {
                            ...
                            {
                                spamCheckDetails?.checkSubjectContentB?.emailSubjectError?.length > 0 ?
                                    spamCheckDetails?.checkSubjectContentB?.emailSubjectError.map((v, i) => (
                                        <div key={i} className="col-12 d-flex ml-5 my-2 align-items-center">
                                            <i className="far fa-times-circle error-circle"></i>
                                            <p className="mb-0">{v}</p>
                                            <i className="far fa-question-circle ml-3 font-size-18" onClick={() => { handleClickModalOpen(v) }}></i>
                            ...
                            <div className="col-12 d-flex align-items-center mt-3">
                                {
                                    typeof spamCheckDetails?.checkSubjectContentB?.emailContentColor === "undefined" ?
                                        <div className="spam-check-indicator"><div className="lds-ripple"><div></div><div></div></div></div>
                                        :
                                        <div className={`spam-check-indicator ${spamCheckDetails.checkSubjectContentB.emailContentColor === 1 ? "green" : "red"}`}></div>
                                }
                                <p className="mb-0">Email Content Check</p>
                                {
                                    typeof spamCheckDetails?.checkSubjectContentB?.emailContentColor !== "undefined" ?
                                        <i className="far fa-question-circle ml-3 font-size-18" data-toggle="tooltip" title={`${spamCheckDetails.checkSubjectContentB.emailContentColor === 1 ? "Good to go" : "May be SPAM"}`}></i>
                                        : null
                                }
                            </div>
                            {
                                spamCheckDetails?.checkSubjectContentB?.emailContentError?.length > 0 ?
                                    spamCheckDetails?.checkSubjectContentB?.emailContentError.map((v, i) => (
                                        <div key={i} className="col-12 d-flex ml-5 mt-1 mb-1 align-items-center">
                                            <i className="far fa-times-circle error-circle"></i>
                                            <p className="mb-0">{v}</p>
                                            <i className="far fa-question-circle ml-3 font-size-18" onClick={() => { handleClickModalOpen("Content " + v) }}></i>
