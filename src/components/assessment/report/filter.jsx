...
import { getAssessmentReportAnswersComboList, getAssessmentReportQuestionsComboList } from '../../../services/assessmentService';
...
const Filter = ({ id, globalAlert, displayAssessmentReportDataBrowser }) => {
    ...
    const getAnswerList = useCallback((value) => {
        let requestData = `queId=${value}&assId=${id}`;
        getAssessmentReportAnswersComboList(requestData).then(res => {
            if (res.status === 200) {
    ...
    const handleClickView = () => {
        ...
        displayAssessmentReportDataBrowser(requestData);
    }
    ...
    useEffect(() => {
        ...
        getAssessmentReportQuestionsComboList(requestData).then(res => {
            if (res.status === 200) {
