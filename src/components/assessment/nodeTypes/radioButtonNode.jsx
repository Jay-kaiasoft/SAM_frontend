        ...
        <div className='p-2 survey-node-wrapper' style={{border: `2px solid ${data.borderColor}`}}>
            ...
            <div className='node-question px-1'>
                <p data-toggle="tooltip" title={data.question}>
                    {data.question.length > 60 ? data.question.substr(0,57)+"..." : data.question}
                </p>
            </div>
                        ...
                        return (
                            <div key={i} className="position-relative">
                                <div className='d-flex justify-content-between align-items-center'>
                                    <p className='px-1 m-0' data-toggle="tooltip" title={v}>
                                        {v.length > 30 ? v.substr(0,27)+"..." : v}&nbsp;{data.points[i] !== null && data.points[i] !== ""? `(PTs-${data.points[i]})`:""}
                                    </p>
                                    <p className='pr-1 pl-2 m-0' data-toggle={optionCheckBoxFormNameVal[i] !== ""?"tooltip": ""} data-original-title={optionCheckBoxFormNameVal[i] !== ""?optionCheckBoxFormNameVal[i]:""} data-trigger="hover">
