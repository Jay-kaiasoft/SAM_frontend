...
import {getSmsPollingReportAnswersComboList, getSmsPollingReportQuestionsComboList} from "../../../services/smsPollingService";
...
const Filter = ({id, globalAlert, displaySmsPollingReportDataBrowser}) => {
    ...
    const getAnswerList = useCallback((value) => {
        let requestData = `queId=${value}`;
        getSmsPollingReportAnswersComboList(requestData).then(res => {
            if(res.status === 200){
                if (res.result && res.result.answers) {
    ...
    const handleClickView = () => {
        ...
        displaySmsPollingReportDataBrowser(requestData);
    }
    ...
    useEffect(()=>{
        ...
        getSmsPollingReportQuestionsComboList(requestData).then(res => {
            if(res.status === 200){
