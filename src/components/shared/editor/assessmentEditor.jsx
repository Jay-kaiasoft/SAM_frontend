...
import {loadeverytime} from "./js/eas_js_assessment";
...
const AssessmentEditor = ({data,globalAlert,categoryPageList,setLoader}) => {
    let tabRef = useRef([createRef(), createRef(), createRef(), createRef()]);
    ...
    useEffect(() => {
        ...
        require('./js/eas_js_assessment.js');
    ...
    return (
        <>
                ...
                <Col md={12}>
                    <Row>
                        <Col md={12}>
                            ...
                            <CategoryMenu/>
                            <ControlMenu tabRef={tabRef} showPopper={showPopper} arrowRef={arrowRef} setArrowRef={setArrowRef} handleClickAway={handleClickAway}/>
                            <div id="editordiv" className="min-height-div">
                                <div id="main" style={{backgroundColor: "#d6ddec"}}>
                                    {
                                        typeof data.atHtml === "undefined" || data.atHtml === "" ?
                                            <div id="preview-template">
                                                <div className="mcd np" style={{padding: "20px 0px"}} item-value="0">
                                                    <center id="cntr" style={{backgroundColor:"#ffffff"}} item-value="0">
                                                        ...
                                                        <div id="templateBody1" className="templateBody d-flex" item-value="0" item-transition="fade" question-style="horizontal" page-category={categoryPageList[0]?.catName} page-category-id={categoryPageList[0]?.id} page-category-color={categoryPageList[0]?.color} page-unique-id={uuidv4()}>
                                                            <div className="questionBlock w-100">
                                                                <div className="catmaxpointsmain">Max Points : <span className="catmaxpoints">0</span></div>
                                        ...
                                        :
                                            <div id="preview-template" dangerouslySetInnerHTML={{ __html: data.atHtml }}/>
                                    }
                                </div>
                            </div>
            ...
            <ZoomModal />
            <EditCategoryStyleModal editorType={"assessment"}/>
...
export default connect(null, mapDispatchToProps)(AssessmentEditor);