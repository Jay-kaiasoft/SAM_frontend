...
import {loadeverytime} from "./js/eas_js_form";
import {setGlobalAlertAction} from "../../../actions/globalAlertActions";
import $ from "jquery";
import ThankYouPage from "./commonComponents/thankYouPage";
import {ControlMenu, DraggableSettingsMenu, ZoomModal} from "./commonComponentsForEditor";
import {setLoader} from "../../../actions/loaderActions";

const FormEditor = ({data,globalAlert,setLoader}) => {
                ...
                <Col md={12}>
                    <Row>
                        <Col md={12}>
                            ...
                            <ControlMenu type="formEditor" tabRef={tabRef} showPopper={showPopper} arrowRef={arrowRef} setArrowRef={setArrowRef} handleClickAway={handleClickAway}/>
                            <div id="editordiv" className="min-height-div">
                                <div id="main" style={{backgroundColor: "#d6ddec"}}>
                                    {
                                        typeof data.cfFormHtml === "undefined" || data.cfFormHtml === "" ?
                                            <div id="preview-template" form-type={data.cfFormType}>
                                                <div className="mcd np" style={{padding: "20px 0px"}} item-value="0">
                                                    <center id="cntr" style={{backgroundColor:"#ffffff"}} item-value="0">
                                                        ...
                                                        <div id="templateBody1" className="templateBody d-flex" item-value="0" item-transition="fade" question-style="all" >
                                        ...
                                        :
                                            <div id="preview-template" form-type={data.cfFormType} dangerouslySetInnerHTML={{ __html: data.cfFormHtml }}/>
                                    }
                                </div>
                            </div>
