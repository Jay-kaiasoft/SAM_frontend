...
CKEDITOR.plugins.add("mergetags", {
    requires: ["richcombo"],
    init: function(a) {
        CKEDITOR.mergeTags.addExternal("merges", a.config.mergeTags);
        a.ui.addRichCombo("Merges", {
            label: "Fields",
            title: "Fields",
            voiceLabel: "Fields",
            ...
            init: function() {
                var a = this;
                CKEDITOR.mergeTags.load("merges", function(d) {
                    d = d.merges;
...
CKEDITOR.mergeTags = new CKEDITOR.resourceManager("", "mergeTags");